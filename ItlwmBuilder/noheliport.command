...
FINAL_DIR="${2}/itlwm_Without_Heliport"


builditlwm() {
  xcodebuild -scheme fw_gen -sdk macosx10.15 BUILD_DIR=${BUILD_DIR}/itlwm/build build >/dev/null || exit 1
  xcodebuild -scheme itlwm -sdk macosx10.15 BUILD_DIR=${BUILD_DIR}/itlwm/build build >/dev/null || exit 1
}

copyBuildProducts() {
  cp -r "${BUILD_DIR}/itlwm/build/Debug/itlwm.kext" "${FINAL_DIR}"
  echo "All Done!..."
}
...
cd "${BUILD_DIR}/itlwm"
echo "Compiling the latest commited Debug version of itlwm..."
builditlwm
echo "itlwm Without HeliPort Completed..."
